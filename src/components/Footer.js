          ...
          <div className="grid sm:grid-cols-12 gap-5 py-8 md:py-12 border-t border-gray-200 lg:ml-11">
            ...
            <div className="col-span-12 lg:col-span-4">
              <div className="box-border border-b-4 border-blue-900 p-8 bg-gray-200 text-gray-600 text-center rounded-lg xl:w-80 mx-auto">
                <h3 className="font-bold text-4xl mb-4">peplies consult</h3>
            ...
            <div className="col-span-6 md:col-span-6 lg:col-span-1 ml-7 mx-auto">
              <h6 className="text-[#013289] text-xl font-bold mb-4">{language === "de" ? "LINKS" : "LINKS"}</h6>
            ...
            <div className="col-span-6 md:col-span-6 lg:col-span-4 mx-auto">
              <h6 className="text-[#013289] text-xl font-bold mb-4">{language === "de" ? "LEISTUNGEN" : "SERVICES"}</h6>
              <ul className="text-md">
                <li className="mb-2">
                  <Link
                    to="#"
            ...
            <div className="col-span-12 text-center mx-auto lg:col-span-3 font-bold uppercase text-blue-900">
              <div className="text-xl mb-1">{language === "de" ? "Social Media" : "Social Media"}</div>
              <div className="text-md font-medium mb-6">{language === "de" ? "Folge uns" : "Follow us"}</div>
