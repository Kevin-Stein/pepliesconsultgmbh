...
const Privacy = () => {
  ...
  const docTitle =
    locale === "de"
      ? "peplies consult - Datenschutz"
      : locale === "fr"
        ? "peplies consult - Politique de confidentialité"
        : locale === "es"
          ? "peplies consult - Política de privacidad"
          : "peplies consult - Privacy Policy";
  ...
  return (
    <div className="bg-white py-12 sm:py-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-8">
        <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-8">{heading}</h1>
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-gray-600 font-semibold text-base md:text-xl mb-6">
            {locale === "de" ? "2. Datenerfassung auf unserer Website" : "2. Data collection on our website"}
          </p>
          <p className="text-gray-600 font-semibold text-base md:text-xl mb-6">
            {locale === "de"
          ...
          <p className="text-gray-600 font-semibold text-base md:text-xl mb-6">
            {locale === "de" ? "3. Ihre Rechte" : "3. Your rights"}
          </p>
          <p className="text-gray-600 font-semibold text-base md:text-xl mb-6">
            {locale === "de"
