...
const Contact = ({ language }) => {
  ...
  const sendEmail = (e) => {
    ...
    document.getElementById("submitBtn").innerHTML = language === "de" ? "Laden..." : "Loading...";
    ...
    axios({
      ...
      .then(function (response) {
        ...
        document.getElementById("submitBtn").innerHTML = language === "de" ? "Nachricht senden" : "Send Message";
        clearInput();
        //handle success
        Notiflix.Report.success(language === "de" ? "Erfolg" : "Success", response.data.message, "Okay");
      })
            ...
            <div className="w-full bg-white p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
              <div className="flex">
                <h1 className="font-bold text-center lg:text-left text-blue-900 uppercase text-4xl">
                  {language === "de" ? "Schicken Sie uns eine Nachricht" : "Send us a message"}
                </h1>
              </div>
